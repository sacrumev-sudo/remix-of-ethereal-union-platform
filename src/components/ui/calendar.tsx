  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-transparent text-primary ring-2 ring-primary ring-offset-2 ring-offset-background hover:bg-primary/10 hover:text-primary focus:bg-transparent focus:text-primary rounded-full",
