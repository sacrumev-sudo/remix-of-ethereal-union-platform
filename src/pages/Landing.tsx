    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="min-h-[65vh] flex items-center justify-center pt-24 pb-8 px-8">
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
          {/* Portrait (uses your uploaded slide as the explicit source) */}
          <div className="flex justify-center lg:justify-start">
            <div className="relative w-72 h-72 md:w-[420px] md:h-[420px] rounded-full overflow-hidden">
              <img
                ...
                style={{
                  // Crop/zoom to the portrait area in the uploaded slide
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-6 text-sm md:text-base text-foreground/40 tracking-widest uppercase">
      ...
      >
        ...
        <div className="relative z-10 flex flex-wrap items-center justify-center gap-8 md:gap-16 px-8">
          {/* Test Circle */}
          <button onClick={() => handleCircleClick('test')} className="circle-button">
          ...
          {/* Practices Circle */}
          <button onClick={() => handleCircleClick('practices')} className="circle-button">
